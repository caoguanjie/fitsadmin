export default function registerPush(lf:any, clickPlus:any, mouseDownPlus:any) {
    lf.register('push', ({ PolygonNode, PolygonNodeModel, h }:{ PolygonNode:any, PolygonNodeModel:any, h:any }) => {
        ...
        getPulsShape() {
          ...
          return h(
            'svg',
            {
              ...
              viewBox: '0 0 1024 1024',
              class: 'time-plus',
              onClick: (e:any) => clickPlus(e, model),
              onMousedown: (e:any) => mouseDownPlus(e, model),
              onMouseUp: (e:any) => mouseDownPlus(e, model)
            },
            h(
              'path',
              {
