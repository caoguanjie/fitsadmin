...
export const useLogger = () => {
    ...
    const log = {
        primary: (content?: any, title = 'Vue3PersistStorage:') => {
            print(title, content)
        },
        success: (content?: any, title = 'Vue3PersistStorage:') => {
            print(title, content, 'success')
        },
        info: (content?: any, title = 'Vue3PersistStorage:') => {
            print(title, content, 'info')
        },
        warning: (content?: any, title = 'Vue3PersistStorage:') => {
            print(title, content, 'warning')
        },
        danger: (content?: any, title = 'Vue3PersistStorage:') => {
