...
import { VXETableCore, VxeTableDefines, VxeFormItemProps, renderer as Renderer, VxeColumnPropTypes, VxeGlobalRendererHandles, VxeGlobalInterceptorHandles, FormItemRenderOptions, FormItemContentRenderParams } from 'vxe-table'
import dayjs from 'dayjs'
import { ToolbarSearch, ToolbarFullscreen, ToolbarCustomColumn, ToolbarRefresh, ToolbarExport, ToolbarSetting, FitsTreeSelect, FitsIconSelect } from 'fits-admin-ui'
...
export const VXETablePluginElement = {
    install(vxetablecore: VXETableCore) {
        if (!vxetablecore.renderer) vxetablecore.renderer = Renderer
